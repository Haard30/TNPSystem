<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CompanyProfile.aspx.cs" Inherits="TnpSystem.StudentPortal.CompanyProfile" %>
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
					...
					<a href="ViewStats.aspx"><i class="fa fa-bar-chart-o"></i> View Stats</a>
                     ...
                     <li>
                        <a  class="active-menu" href="CompanyProfile.aspx"><i class="fa fa-desktop"></i> Company Profile</a>
                    </li>
                </ul>
			...
			<div class="panel panel-default">
				<div class="panel-heading">
				 ...
				 <div class="form-group">
                    ...
                    <div class="form-group">
                        <asp:label runat="server" Font-Bold="True" Font-Size="Large">Company Name :<sup>*</sup></asp:label>   <br />  <br/>
                        <asp:DropDownList ID="CompanyNameList" runat="server" Width="30%" Height="40%" AutoPostBack="True" OnSelectedIndexChanged="CompanyNameList_SelectedIndexChanged">
                        </asp:DropDownList>
                    </div>
                    
                      <div class="alert alert-success">
                <asp:Label ID="CompProfile" runat="server" ForeColor="Black" BorderColor="#252526" Font-Bold="True" Font-Size="Medium"></asp:Label>
	            </div>
