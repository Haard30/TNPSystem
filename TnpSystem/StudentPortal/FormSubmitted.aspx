<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormSubmitted.aspx.cs" Inherits="TnpSystem.StudentPortal.FormSubmitted" %>
				 ...
				 Your form submission status: 
							...
							<div class="panel-body"> 
								<div class="alert alert-success">
									<strong>Well done!</strong> You have successfully submitted the form. For any queries please contact co-ordinator!
								</div>
							</div>
				</div>
			</div>						
