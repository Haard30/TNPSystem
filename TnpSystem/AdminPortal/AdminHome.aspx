<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminHome.aspx.cs" Inherits="TnpSystem.AdminPortal.AdminHome" %>
            ...
            <nav class="navbar-default navbar-side" role="navigation">
                <div class="sidebar-collapse">
                    <ul class="nav" id="main-menu">
                        ...
                        <li>
                            <a class="active-menu" href="AdminHome.aspx"><i class="fa fa-dashboard"></i>My Profile</a>
                        </li>
                        <li>
            ...
            <div id="page-wrapper">
                <div id="page-inner">
                    ...
                    <div class="form-group">
                        ...
                        <asp:TextBox class="form-control" ID="AdminProfileId" runat="server" type="text" placeholder="Auto-generated" disabled="" Width="30%" OnTextChanged="AdminProfileId_TextChanged"></asp:TextBox>
                    </div>


                    <div class="form-group">
                        <label>Name</label>
                        <asp:TextBox class="form-control" placeholder="Enter Name" ID="AdminProfileName" runat="server" Width="30%" OnTextChanged="AdminProfileName_TextChanged" AutoPostBack="True"></asp:TextBox>
                    </div>

                    <div class="form-group">
                        <label>E-mail-ID</label>
                        <asp:TextBox class="form-control" placeholder="Enter E-mail" ID="AdminProfileEmail" runat="server" Width="30%" OnTextChanged="AdminProfileEmail_TextChanged"></asp:TextBox>
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server"
                            ErrorMessage="Please enter a valid email" ControlToValidate="AdminProfileEmail"
                ...
                <asp:Button ID="AdminProfileUpdate" CssClass="myButton" type="submit" runat="server" align="center" Text="Update Profile"  Width="25%" OnClick="AdminProfileUpdate_Click"></asp:Button>
                        ...
                        <p>&nbsp;</p>
                        <asp:Label ID="UpdateAdminAction" runat="server" Width="30%" ForeColor="#009933" Font-Bold="True" Font-Size="Medium"></asp:Label>
